/*
  ...
  - You are about to drop the column `icons` on the `specialties` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "doctor" ALTER COLUMN "gender" DROP DEFAULT;

-- AlterTable
ALTER TABLE "specialties" DROP COLUMN "icons",
